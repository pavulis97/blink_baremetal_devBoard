...
PROJECTNAME := blink_baremetal_devBoard
SRC := .
...
-include blink_baremetal_devBoard.vscode.project.mak


ASM_INCLUDES := -I"config" -I"autogen" -I"." -I"$(COPIED_SDK_PATH)/platform/Device/SiliconLabs/EFR32ZG23/Include" -I"$(COPIED_SDK_PATH)/platform/common/inc" -I"$(COPIED_SDK_PATH)/hardware/board/inc" -I"$(COPIED_SDK_PATH)/platform/driver/button/inc" -I"$(COPIED_SDK_PATH)/platform/CMSIS/Core/Include" -I"$(COPIED_SDK_PATH)/hardware/driver/configuration_over_swo/inc" -I"$(COPIED_SDK_PATH)/platform/driver/debug/inc" -I"$(COPIED_SDK_PATH)/platform/service/device_init/inc" -I"$(COPIED_SDK_PATH)/platform/emdrv/common/inc" -I"$(COPIED_SDK_PATH)/platform/emlib/inc" -I"$(COPIED_SDK_PATH)/platform/emdrv/gpiointerrupt/inc" -I"$(COPIED_SDK_PATH)/platform/service/hfxo_manager/inc" -I"$(COPIED_SDK_PATH)/platform/driver/leddrv/inc" -I"$(COPIED_SDK_PATH)/hardware/driver/mx25_flash_shutdown/inc/sl_mx25_flash_shutdown_usart" -I"$(COPIED_SDK_PATH)/platform/peripheral/inc" -I"$(COPIED_SDK_PATH)/platform/service/power_manager/inc" -I"$(COPIED_SDK_PATH)/platform/common/toolchain/inc" -I"$(COPIED_SDK_PATH)/platform/service/system/inc" -I"$(COPIED_SDK_PATH)/platform/service/sleeptimer/inc" -I"$(COPIED_SDK_PATH)/platform/service/udelay/inc" 
